        ...
        <div class="wrapper">
            ...
            <form id="form_cadastro" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="firstname" id="firstname-input" placeholder="Nome">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="repeat-email" id="email-repeat-input" placeholder="Confirmar email">
                </div>
                <div>
