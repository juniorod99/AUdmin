<dialog>
    ...
    <div class="options">
        <button class="btnClose">Não</button>
        <button class="btnSubmit">Sim</button>
    </div>
</dialog>